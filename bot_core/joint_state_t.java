...
public final class joint_state_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(bot_core.joint_state_t.class))
            return 0L;
 
        classes.add(bot_core.joint_state_t.class);
    ...
    public static bot_core.joint_state_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        bot_core.joint_state_t o = new bot_core.joint_state_t();
    ...
    public bot_core.joint_state_t copy()
    {
        bot_core.joint_state_t outobj = new bot_core.joint_state_t();
