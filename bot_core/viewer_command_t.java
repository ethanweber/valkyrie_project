...
public final class viewer_command_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(bot_core.viewer_command_t.class))
            return 0L;
 
        classes.add(bot_core.viewer_command_t.class);
    ...
    public static bot_core.viewer_command_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        bot_core.viewer_command_t o = new bot_core.viewer_command_t();
    ...
    public bot_core.viewer_command_t copy()
    {
        bot_core.viewer_command_t outobj = new bot_core.viewer_command_t();
