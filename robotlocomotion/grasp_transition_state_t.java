...
public final class grasp_transition_state_t implements lcm.lcm.LCMEncodable
{
    ...
    public bot_core.position_3d_t hand_pose;
    ...
    {
        if (classes.contains(robotlocomotion.grasp_transition_state_t.class))
            return 0L;
 
        classes.add(robotlocomotion.grasp_transition_state_t.class);
    ...
    public static robotlocomotion.grasp_transition_state_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        robotlocomotion.grasp_transition_state_t o = new robotlocomotion.grasp_transition_state_t();
    ...
    public void _decodeRecursive(DataInput ins) throws IOException
    {
        ...
        this.hand_pose = bot_core.position_3d_t._decodeRecursiveFactory(ins);
    ...
    public robotlocomotion.grasp_transition_state_t copy()
    {
        robotlocomotion.grasp_transition_state_t outobj = new robotlocomotion.grasp_transition_state_t();
