...
public final class quaternion_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(robotlocomotion.quaternion_t.class))
            return 0L;
 
        classes.add(robotlocomotion.quaternion_t.class);
    ...
    public static robotlocomotion.quaternion_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        robotlocomotion.quaternion_t o = new robotlocomotion.quaternion_t();
    ...
    public robotlocomotion.quaternion_t copy()
    {
        robotlocomotion.quaternion_t outobj = new robotlocomotion.quaternion_t();
        outobj.w = this.w;
