...
public final class robot_plan_w_keyframes_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(robotlocomotion.robot_plan_w_keyframes_t.class))
            return 0L;
 
        classes.add(robotlocomotion.robot_plan_w_keyframes_t.class);
    ...
    public static robotlocomotion.robot_plan_w_keyframes_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        robotlocomotion.robot_plan_w_keyframes_t o = new robotlocomotion.robot_plan_w_keyframes_t();
    ...
    public robotlocomotion.robot_plan_w_keyframes_t copy()
    {
        robotlocomotion.robot_plan_w_keyframes_t outobj = new robotlocomotion.robot_plan_w_keyframes_t();
