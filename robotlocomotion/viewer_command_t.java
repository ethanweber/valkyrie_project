...
public final class viewer_command_t implements lcm.lcm.LCMEncodable
{
    public byte command_type;
    public String command_data;
 
    public viewer_command_t()
    {
    }
    ...
    {
        if (classes.contains(robotlocomotion.viewer_command_t.class))
            return 0L;
 
        classes.add(robotlocomotion.viewer_command_t.class);
    ...
    public viewer_command_t(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public viewer_command_t(DataInput ins) throws IOException
    {
    ...
    public static robotlocomotion.viewer_command_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        robotlocomotion.viewer_command_t o = new robotlocomotion.viewer_command_t();
    ...
    public robotlocomotion.viewer_command_t copy()
    {
        robotlocomotion.viewer_command_t outobj = new robotlocomotion.viewer_command_t();
