...
public final class viewer_draw_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(robotlocomotion.viewer_draw_t.class))
            return 0L;
 
        classes.add(robotlocomotion.viewer_draw_t.class);
    ...
    public viewer_draw_t(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public viewer_draw_t(DataInput ins) throws IOException
    {
    ...
    public static robotlocomotion.viewer_draw_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        robotlocomotion.viewer_draw_t o = new robotlocomotion.viewer_draw_t();
    ...
    public robotlocomotion.viewer_draw_t copy()
    {
        robotlocomotion.viewer_draw_t outobj = new robotlocomotion.viewer_draw_t();
