...
public final class viewer_geometry_data_t implements lcm.lcm.LCMEncodable
{
    public byte type;
    ...
    public static final byte ELLIPSOID = (byte) 6;
    ...
    {
        if (classes.contains(robotlocomotion.viewer_geometry_data_t.class))
            return 0L;
 
        classes.add(robotlocomotion.viewer_geometry_data_t.class);
    ...
    public viewer_geometry_data_t(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public viewer_geometry_data_t(DataInput ins) throws IOException
    {
    ...
    public static robotlocomotion.viewer_geometry_data_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        robotlocomotion.viewer_geometry_data_t o = new robotlocomotion.viewer_geometry_data_t();
    ...
    public robotlocomotion.viewer_geometry_data_t copy()
    {
        robotlocomotion.viewer_geometry_data_t outobj = new robotlocomotion.viewer_geometry_data_t();
